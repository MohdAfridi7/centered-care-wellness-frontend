...
export default function MissionSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="text-gray-900 py-20 px-6 md:px-16 overflow-hidden"
    >
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <motion.p
            ...
            className="mt-6 text-gray-800 leading-relaxed max-w-lg"
          >
           Our mission is to deliver high-quality, accessible, and compassionate healthcare through a patient-centered approach. We are committed to improving outcomes by providing personalized care, advanced solutions, and continuous support for every stage of your health journey.
          </motion.p>
          ...
          >
            {["Patient-Centered Care", "Compassion & Trust", "Continuous Support", "Accessible Healthcare"].map(
              (item, i) => (
